...
CGO_ENABLED=1 GOARCH=arm go build -o ./build/raspi_server cmd/ble-oob-exchange/main.go
...
rpi_ssh pi@$HOST 'sudo LD_LIBRARY_PATH="/usr/local/lib" /tmp/raspi_server'